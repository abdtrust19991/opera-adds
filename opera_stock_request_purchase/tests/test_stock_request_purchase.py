...
class TestStockRequestPurchase(common.TransactionCase):
    def setUp(self):
        ...
        self.stock_request_user_group = self.env.ref(
            "opera_stock_request.group_stock_request_user"
        )
        self.stock_request_manager_group = self.env.ref(
            "opera_stock_request.group_stock_request_manager"
        )
    ...
    def test_create_request_02(self):
        ...
        stock_request_1 = self.opera_stock_request.with_user(self.stock_request_user).create(
            vals
        )
        stock_request_2 = self.opera_stock_request.with_user(
