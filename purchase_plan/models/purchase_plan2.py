...
class purchase_plan(models.Model):
    ...
    plan_line_ids = fields.Many2many(comodel_name="purchase.plan.line",relation="plan_line_rel", column1="pln_id", column2="pln_lin_id", string="Plan Lines", required=True)
    actual_line_ids = fields.Many2many(comodel_name="purchase.plan.line",relation="actual_line_rel", column1="actual_id", column2="po_lin_id", string="Actual Lines",readonly=True )
    diff_line_ids = fields.Many2many(comodel_name="purchase.plan.line",relation="diff_line_rel", column1="diff_pln_id", column2="diff_lin_id", string="Difference Lines",readonly=True )
    rat_line_ids = fields.Many2many(comodel_name="purchase.plan.line",relation="rat_line_rel", column1="rat_pln_id", column2="rat_lin_id", string="Ratio Lines", readonly=True)
